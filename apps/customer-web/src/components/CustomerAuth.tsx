...
const unavailable: AuthCapabilities = { password_login: false, public_registration: false, telegram_login: false, telegram_linking: false, web_credential_enrollment: false, email_recovery: false, telegram_recovery: false, recovery_codes: false, manual_card_topups: false };
