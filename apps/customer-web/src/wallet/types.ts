...
export type WalletBucketBalance = { bucket_type: WalletBucket; customer_label: string; balance_rial: number; expires_at?: string | null };
export type WalletSummary = { currency: "IRR"; status: WalletStatus; posted_balance_rial: number; reserved_balance_rial: number; available_balance_rial: number; buckets: WalletBucketBalance[]; updated_at: string; has_expiring_credit: boolean; active_reservation_count: number };
