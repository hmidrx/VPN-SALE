...
export const managementNav: NavItem[] = [
  ...
  { href: "/management/finance", label: "مالی", permissions: ["wallets.read", "ledger.read", "ledger.reconcile"] },
