...
INITIAL_PERMISSIONS: tuple[tuple[str, str], ...] = (
    ...
    ("manual_topups.read", "Read manual top-up evidence and review queue"),
    ...
    ("production_releases.read", "Read production release console"),
    ("production_releases.manage", "Manage production release plans"),
    ("production_releases.request", "Request production release approval"),
    ("production_releases.approve", "Approve production releases"),
    ("production_releases.deploy", "Execute protected production deployment workflow"),
    ("production_releases.start_canary", "Start production canary phases"),
    ("production_releases.advance", "Advance production rollout phases"),
    ("production_releases.pause", "Pause production rollouts"),
    ("production_releases.resume", "Resume production rollouts"),
    ("production_releases.rollback", "Execute production rollback"),
    ("production_releases.manage_cohorts", "Manage production release cohorts"),
    ("production_releases.manage_hypercare", "Manage production hypercare"),
