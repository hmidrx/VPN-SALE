...
def _native_order_result(db: Session, order: OrderModel) -> dict[str, object]:
    ...
    service_projection = (
        customer_service_projection(db, order.customer_id, service.public_reference)
    ...
    return {
        ...
        "service_lifecycle": service.lifecycle if service else None,
        "delivery_ready": bool(service_projection and service_projection.summary.delivery_ready),
